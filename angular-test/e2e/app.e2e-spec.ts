...
describe('Starting tests for angular-test', function() {
  ...
  it('network-name should be sopb@0.0.2',() => {
    element(by.css('.network-name')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('sopb@0.0.2.bna');
    });
  });
  ...
  it('navbar-brand should be angular-test',() => {
    ...
    it('Owner table should have 6 columns',() => {
      page.navigateTo('/Owner');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('MakeProduct component should be loadable',() => {
      page.navigateTo('/MakeProduct');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('MakeProduct');
      });
    });
  
    it('InitialTransfer component should be loadable',() => {
      page.navigateTo('/InitialTransfer');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('InitialTransfer');
      });
    });
    ...
    it('AcceptProduct component should be loadable',() => {
      page.navigateTo('/AcceptProduct');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('AcceptProduct');
      });
    });
