...
import { MakeProductService } from './MakeProduct.service';
import 'rxjs/add/operator/toPromise';

@Component({
  selector: 'app-makeproduct',
  templateUrl: './MakeProduct.component.html',
  styleUrls: ['./MakeProduct.component.css'],
  providers: [MakeProductService]
})
export class MakeProductComponent implements OnInit {
  ...
  constructor(private serviceMakeProduct: MakeProductService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceMakeProduct.getAll()
    .toPromise()
    .then((result) => {
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.sopb.mynetwork.MakeProduct',
      'id': this.id.value,
    ...
    return this.serviceMakeProduct.addTransaction(this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.myForm.setValue({
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceMakeProduct.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceMakeProduct.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  getForm(id: any): Promise<any> {
    ...
    return this.serviceMakeProduct.getTransaction(id)
    .toPromise()
    .then((result) => {
      this.errorMessage = null;
      const formObject = {
