...
describe('MakeProductComponent', () => {
  ...
  let mockMakeProductService;
  let mockDataService

  beforeEach(async(() => {

    mockMakeProductService = sinon.createStubInstance(MakeProductService);
    mockMakeProductService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: MakeProductService, useValue: mockMakeProductService },
