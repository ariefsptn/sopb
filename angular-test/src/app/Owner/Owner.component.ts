...
export class OwnerComponent implements OnInit {
  ...
  ownerContact = new FormControl('', Validators.required);
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      ...
      'ownerLocation': this.ownerLocation.value,
      'ownerContact': this.ownerContact.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceOwner.updateParticipant(form.get('userKey').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.ownerLocation) {
        formObject.ownerLocation = result.ownerLocation;
      } else {
        formObject.ownerLocation = null;
      }

      if (result.ownerContact) {
        formObject.ownerContact = result.ownerContact;
      } else {
        formObject.ownerContact = null;
      }

      if (result.userKey) {
        formObject.userKey = result.userKey;
      } else {
        formObject.userKey = null;
      }
