...
import { AcceptProductComponent } from './AcceptProduct.component';
...
describe('AcceptProductComponent', () => {
  ...
  let mockAcceptProductService;
  let mockDataService

  beforeEach(async(() => {

    mockAcceptProductService = sinon.createStubInstance(AcceptProductService);
    mockAcceptProductService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: AcceptProductService, useValue: mockAcceptProductService },
