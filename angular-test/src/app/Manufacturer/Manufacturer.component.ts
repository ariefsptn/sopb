...
export class ManufacturerComponent implements OnInit {
  ...
  manuLocation = new FormControl('', Validators.required);
  ...
  constructor(public serviceManufacturer: ManufacturerService, fb: FormBuilder) {
    this.myForm = fb.group({
      ...
      manuLocation: this.manuLocation,
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      ...
      'manuLocation': this.manuLocation.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceManufacturer.updateParticipant(form.get('userKey').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.manuLocation) {
        formObject.manuLocation = result.manuLocation;
      } else {
        formObject.manuLocation = null;
      }
